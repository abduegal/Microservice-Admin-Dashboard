...
(function(window) {
	...
	jQuery.get(getRelativePath("views/hystrix/hystrixCircuit.html"), function(data) {
		hystrixTemplateCircuit = data;
	});
	jQuery.get(getRelativePath("views/hystrix/hystrixCircuitContainer.txt"), function(data) {
